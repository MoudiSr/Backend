...
class Order(models.Model):
	...
	order_Dollar = models.FloatField(default=0)
	order_LBP = models.FloatField(default=0)
	delivery = models.FloatField(default=0)
	delivery_currency = models.CharField(max_length=255, default="null")
	...
	def __str__(self):
		return f"id={self.id}, name={self.dealer_name}, delivery={self.delivery}, status={self.status}"
...
class Expense(models.Model):
	...
	amount_dollar = models.FloatField()
	amount_lbp = models.FloatField()
	date = models.DateField(default=date.today)
	user = models.CharField(max_length=255)

	def __str__(self):
		return f"id={self.id}, payment_id={self.payment_id}"